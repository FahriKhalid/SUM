...
class InvoiceController extends Controller
{
    ...
    public function index($id)
    {
        ...
        return view('invoice.index', compact('info', 'id')); 
    }
        ...
        return Datatables::of($data)->addIndexColumn()->addColumn('action', function ($data){
            return '<div class="btn-group btn-group-sm" role="group">
                    ...
                    <div class="dropdown-menu" aria-labelledby="btnGroupDrop1">
                        <a class="dropdown-item detail" url="'.url('invoice/show/'.Helper::encodex($data->id_invoice)).'"><i class="fa fa-search"></i> Detail</a>
                        <div class="dropdown-divider"></div>
                        <a class="dropdown-item" target="_blank" href="'.url('invoice/surat/'.Helper::encodex($data->id_invoice)).'"><i class="fa fa-file"></i> Invoice</a>
                        <div class="dropdown-divider"></div>
                        <a class="dropdown-item" href="'.url("invoice/edit/".Helper::encodex($data->id_invoice)).'"><i class="fa fa-edit"></i> Edit</a>
                        <div class="dropdown-divider"></div>
                        <a class="dropdown-item hapus" url="'.url('invoice/destroy/'.Helper::encodex($data->id_invoice)).'"  href="javascript:void(0);"><i class="fa fa-trash"></i> Hapus</a>
                    </div>
                </div>';
    ...
    public function create($id)
    {
        ...
        return view('invoice.create', compact('info', 'id'));
    }
    ...
    public function show($id)
    {
        ...
        return response()->json([ 
            'html' => view('invoice.detail_invoice', compact('info', 'id'))->render()
        ]); 
    }
    ...
    public function edit($id)
    {
        ...
        return view('invoice.edit', compact('info', 'id'));
    }
    ...
    public function surat($id){
        ...
        $pdf = PDF::loadview('invoice.surat_invoice', compact('info')); 
