        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar static-top">
                    ...
                    <!-- Topbar Search -->
                    <form class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search" method="get" action="{{ url('pencarian') }}">
                        
                        <div class="input-group">
                            <input type="text" class="form-control bg-light border-0 small" placeholder="Misal: 000"
                                aria-label="Search" aria-describedby="basic-addon2" value="{{ isset($_GET["cari"]) ? $_GET["cari"] : '' }}" name="cari">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow d-sm-none">
                            ...
                            <div class="dropdown-menu dropdown-menu-right p-3 shadow animated--grow-in"
                                ...
                                <form class="form-inline mr-auto w-100 navbar-search" method="get" action="{{ url('pencarian') }}">
