    ...
    <div class="row">
        ...
        <div class="col-md-3">
            <div class="card shadow-sm">
                <div class="card-body">
                    <div>
                        <h6 class="m-0 font-weight-bold text-dark">STOK PRODUK</h6>
                    </div> 
                </div>
                    <div id="pie-chart"></div>
                <div class="">
                    <div class="list-group list-group-flush" style="max-height: 330px; overflow-x: auto;"> 
                        @foreach($info["stok_produk"] as $stok_produk)
                        <div href="javascript:void(0)" class="list-group-item d-flex justify-content-between">
                            <div>
                                <div class="font-weight-bold">{{ $stok_produk->nama }}</div> 
                                <small>{{ $stok_produk->spesifikasi }}</small>
                            </div> 
                            <div class="font-weight-bold">
                                <div>{{ $stok_produk->jumlah }}</div> 
                                <div class="text-right">MT</div>
                            </div>
                        </div>
                        @endforeach
...
let doghnut = {!! json_encode($info["chart_stok_produk"]) !!};
 
let jumlah = [];
let produk = [];
for (var i = 0; i < doghnut.data.length; i++) {
    jumlah.push(doghnut.data[i].jumlah);
    produk.push(doghnut.data[i].produk);
}
