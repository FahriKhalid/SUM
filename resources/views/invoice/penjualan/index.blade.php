...
@include('invoice.penjualan.modal_detail') 
...
<div class="container-fluid mb-4 mt-4">
	...
	<div class="card mt-3 "> 
		<div class="card-body bg-white d-flex justify-content-between"> 
			<a class="btn btn-success" href="{{ url('penjualan/invoice/create/'.$id) }}"><i class="fa fa-plus"></i> Tambah</a>
		</div> 
		<div class="card-body">
...
<script type="text/javascript">
    ...
    */ 
    ...
    var table_invoice = table('#tabel-invoice', '{{url('penjualan/invoice/data')}}/'+'{{$id}}', data_table);
